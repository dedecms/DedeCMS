...
INSERT INTO `#@__channeltype` VALUES (5, 'product', '产品', '#@__archives', '#@__addonproduct', 'archives_add.php', 'content_i_list.php', 'archives_edit.php', 'archives_add.php', 'content_list.php', 'archives_edit.php', '<field:assprice itemname="参考价格" type="float" isnull="true" default="0" function="" maxlength="" page="">\r\n</field:assprice>\r\n<field:bigpic itemname="产品图片" type="imgfile" isnull="true" default="" function="" maxlength="200" page=""></field:bigpic>\r\n\r\n<field:model itemname="产品型号" type="text" isnull="true" default="" function="" maxlength="100" page="">\r\n</field:model>\r\n<field:sptype itemname="供应方式" autofield="0" notsend="0" type="radio" isnull="true" islist="0" default="" function="SelSpType(@me)" maxlength="10" page="">\r\n厂家直销,厂家批发,商家批发,商家零售,其它渠道</field:sptype>\r\n<field:cometime itemname="上市时间" type="datetime"\nisnull="true" default="" function="" maxlength="" page="">\r\n</field:cometime>\r\n<field:brand itemname="产品品牌" type="text" isnull="true" default="" function="" maxlength="30" page="">\r\n</field:brand>\r\n<field:size itemname="产品规格" type="text" isnull="true" default="" function="" maxlength="50" page="">\r\n</field:size>\r\n<field:stuff itemname="产品材质" type="text" isnull="true" default="" function="" maxlength="100" page="">\r\n</field:stuff>\r\n<field:msg itemname="产品详细描述" type="htmltext" isnull="true" default="" function="" maxlength="" page="">\r\n</field:msg>', '', 1, 1, 1, -1, 10, 1, 0);
...
INSERT INTO `#@__sysconfig` VALUES (9, 'cfg_backup_dir', '数据备份目录（在管理目录内）', 'backup_data', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (9, 'cfg_indexname', '主页链接名', '主页', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (9, 'cfg_html_editor', 'Html编辑器选项（仅支持 dede 和 fck）', 'fck', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (10, 'cfg_arcdir', '文档HTML默认保存路径', '/html', 'string', 5);
INSERT INTO `#@__sysconfig` VALUES (11, 'cfg_medias_dir', '图片/上传文件默认路径', '/uploads', 'string', 2);
INSERT INTO `#@__sysconfig` VALUES (12, 'cfg_ddimg_width', '缩略图默认宽度', '240', 'string', 2);
INSERT INTO `#@__sysconfig` VALUES (13, 'cfg_ddimg_height', '缩略图默认高度', '180', 'string', 2);
...
INSERT INTO `#@__sysconfig` VALUES (18, 'cfg_specnote', '专题的最大节点数', '6', 'string', 5);
INSERT INTO `#@__sysconfig` VALUES (19, 'cfg_list_symbol', '栏目位置的间隔符号', '>', 'string', 5);
INSERT INTO `#@__sysconfig` VALUES (20, 'cfg_notallowstr', '禁用词语（系统将直接停止用户动作）', '#没设定#', 'string', 4);
INSERT INTO `#@__sysconfig` VALUES (21, 'cfg_feedbackcheck', '评论及留言(是/否)需审核', 'N', 'bool', 4);
INSERT INTO `#@__sysconfig` VALUES (22, 'cfg_keyword_replace', '关键字替换(是/否)使用本功能会影响HTML生成速度', 'N', 'bool', 4);
INSERT INTO `#@__sysconfig` VALUES (23, 'cfg_fck_xhtml', '编辑器(是/否)使用XHTML', 'N', 'bool', 5);
INSERT INTO `#@__sysconfig` VALUES (24, 'cfg_df_style', '模板默认风格', 'default', 'string', 5);
INSERT INTO `#@__sysconfig` VALUES (25, 'cfg_multi_site', '(是/否)支持多站点，开启此项后附件、栏目连接、arclist内容启用绝对网址', 'N', 'bool', 1);
INSERT INTO `#@__sysconfig` VALUES (26, 'cfg_dede_cache', '(是/否)开启Dede模块引擎的缓存功能', 'N', 'bool', 1);
INSERT INTO `#@__sysconfig` VALUES (27, 'cfg_dede_log', '(是/否)开启管理日志', 'N', 'bool', 1);
INSERT INTO `#@__sysconfig` VALUES (28, 'cfg_powerby', '网站版权信息', '织梦内容管理系统(DedeCms)--国内最专业的PHP网站管理系统，轻松建站的首选利器<script language=''javascript'' src=''/foot.js''></script>', 'string', 5);
INSERT INTO `#@__sysconfig` VALUES (29, 'cfg_arcsptitle', '(是/否)开启分页标题，开启会影响HTML生成速度', 'N', 'bool', 5);
INSERT INTO `#@__sysconfig` VALUES (30, 'cfg_arcautosp', '(是/否)开启长文章自动分页', 'N', 'bool', 5);
INSERT INTO `#@__sysconfig` VALUES (31, 'cfg_arcautosp_size', '文章自动分页大小（单位: K）', '5', 'string', 5);
INSERT INTO `#@__sysconfig` VALUES (32, 'cfg_auot_description', '自动摘要长度（0-250，0表示不启用）', '250', 'string', 5);
INSERT INTO `#@__sysconfig` VALUES (33, 'cfg_ftp_host', 'FTP主机', '', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (34, 'cfg_ftp_port', 'FTP端口', '21', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (35, 'cfg_ftp_user', 'FTP用户名', '', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (36, 'cfg_ftp_pwd', 'FTP密码', '', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (37, 'cfg_ftp_root', '网站根在FTP中的目录', '/', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (38, 'cfg_ftp_mkdir', '是否强制用FTP创建目录', 'N', 'bool', 1);
INSERT INTO `#@__sysconfig` VALUES (39, 'cfg_feedback_ck', '评论加验证码重确认', 'N', 'bool', 4);
INSERT INTO `#@__sysconfig` VALUES (40, 'cfg_list_son', '上级列表是否包含子类内容', 'Y', 'bool', 5);
INSERT INTO `#@__sysconfig` VALUES (41, 'cfg_mb_open', '是否开启会员功能', 'Y', 'bool', 3);
INSERT INTO `#@__sysconfig` VALUES (42, 'cfg_mb_album', '是否开启会员图集功能', 'Y', 'bool', 3);
INSERT INTO `#@__sysconfig` VALUES (43, 'cfg_mb_upload', '是否允许会员上传非图片附件', 'Y', 'bool', 3);
INSERT INTO `#@__sysconfig` VALUES (44, 'cfg_mb_upload_size', '会员上传文件大小(K)', '1024', 'string', 3);
INSERT INTO `#@__sysconfig` VALUES (45, 'cfg_mb_sendall', '是否开放会员对自定义模型投稿', 'Y', 'bool', 3);
INSERT INTO `#@__sysconfig` VALUES (46, 'cfg_mb_rmdown', '是否把会员指定的远程文档下载到本地', 'Y', 'bool', 3);
INSERT INTO `#@__sysconfig` VALUES (47, 'cfg_cli_time', '服务器时区设置<br>(Etc/GMT，适用于PHP>5.1，中国默认设置为-8)', '-8', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (48, 'cfg_mb_mediatype', '会员附件许可的类型', 'jpg|gif|png|bmp|swf|mpg|mp3|rm|rmvb|wmv|asf|wma|zip|rar|doc|xsl|ppt|wps|exe|sis', 'string', 3);
INSERT INTO `#@__sysconfig` VALUES (49, 'cfg_mb_max', '会员附件总大小限制(MB)', '10', 'string', 3);
INSERT INTO `#@__sysconfig` VALUES (20, 'cfg_replacestr', '替换词语（词语会被替换成***）', '她妈|它妈|他妈|你妈|fuck|去死|贱人|老母', 'string', 4);
INSERT INTO `#@__sysconfig` VALUES (50, 'cfg_makeindex', '发布文档后自动更新网站主页', 'N', 'bool', 5);
INSERT INTO `#@__sysconfig` VALUES (51, 'cfg_keyword_like', '使用关键词关连文章', 'Y', 'bool', 5);
INSERT INTO `#@__sysconfig` VALUES (52, 'cfg_online_type', '在线支付网关类型', 'nps', 'string', 3);
INSERT INTO `#@__sysconfig` VALUES (53, 'cfg_jpeg_query', 'JPEG缩略图质量', '85', 'string', 2);
INSERT INTO `#@__sysconfig` VALUES (54, 'cfg_pwdtype', '会员密码类型:none/md5/dd(织梦加密)', 'md5', 'string', -1);
INSERT INTO `#@__sysconfig` VALUES (55, 'cfg_md5len', 'MD5密码位数', '32', 'string', -1);
INSERT INTO `#@__sysconfig` VALUES (56, 'cfg_ddsign', '织梦加密算法密码(6-12位)', '', 'string', -1);
INSERT INTO `#@__sysconfig` VALUES (58, 'cfg_use_vdcode', '是否开启后台登录的验证码', 'N', 'bool', 1);
INSERT INTO `#@__sysconfig` VALUES (78, 'cfg_send_score', '会员投稿增加积分', '2', 'string', 6);
INSERT INTO `#@__sysconfig` VALUES (79, 'cfg_guest_send', '是否允许游客投稿', 'N', 'bool', 6);
INSERT INTO `#@__sysconfig` VALUES (81, 'cfg_al_cachetime', 'arclist标记缓存时间(小时)', '0', 'string', 5);
INSERT INTO `#@__sysconfig` VALUES (82, 'cfg_df_score', '注册会员默认积分', '1000', 'string', 6);
INSERT INTO `#@__sysconfig` VALUES (84, 'cfg_member_regsta', '新注册会员是否需要审核', 'N', 'bool', 3);
INSERT INTO `#@__sysconfig` VALUES (96, 'cfg_up_prenext', '更新单个文档时是否同时更新上一篇和下一篇', 'N', 'bool', 5);
INSERT INTO `#@__sysconfig` VALUES (87, 'cfg_mb_exiturl', '会员退出后默认跳转页', '/', 'string', 6);
INSERT INTO `#@__sysconfig` VALUES (89, 'cfg_ct_mode', '内容管理模式(0-传统，1-分表)', '1', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (90, 'cfg_mb_score2money', '是否开启积分和金币兑换功能', 'Y', 'bool', 3);
INSERT INTO `#@__sysconfig` VALUES (91, 'cfg_score2money', '多少积分兑换一个金币', '3', 'string', 3);
INSERT INTO `#@__sysconfig` VALUES (92, 'cfg_money2score', '一个金币购买多少积分', '3', 'string', 3);
INSERT INTO `#@__sysconfig` VALUES (104, 'cfg_websafe_open', '系统转为维护状态(仅允许访问后台及前台部份程序)', 'N', 'bool', 1);
INSERT INTO `#@__sysconfig` VALUES (99, 'cfg_cat_seltype', '栏目选择类型(0-弹窗、1-select列表)', '1', 'string', 5);
INSERT INTO `#@__sysconfig` VALUES (100, 'cfg_arc_all', '是否在arclist标记中包含附加表指定的字段', 'N', 'bool', 5);
INSERT INTO `#@__sysconfig` VALUES (101, 'cfg_gif_wartermark', 'gif图片是否增加水印', 'N', 'bool', 2);
INSERT INTO `#@__sysconfig` VALUES (102, 'cfg_allsearch_limit', '网站全局搜索时间限制', '1', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (103, 'cfg_search_maxlimit', '搜索结果最大数限制', '500', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (105, 'cfg_search_cachetime', '搜索缓存有效期（单位：小时）', '1', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (106, 'cfg_locked_day', '会员文章加锁时间(天)<br>审核后多少天不能再修改', '7', 'string', 3);
INSERT INTO `#@__sysconfig` VALUES (107, 'cfg_sendmail_bysmtp', '是否启用smtp方式发送邮件', 'Y', 'bool', 1);
INSERT INTO `#@__sysconfig` VALUES (108, 'cfg_smtp_server', 'smtp服务器', 'smtp.xinhuanet.com', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (109, 'cfg_smtp_port', 'smtp服务器端口', '25', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (110, 'cfg_smtp_usermail', 'SMTP服务器的用户邮箱', 'rong112@xinhuanet.com', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (111, 'cfg_smtp_user', 'SMTP服务器的用户帐号', 'rong112', 'string', 1);
INSERT INTO `#@__sysconfig` VALUES (112, 'cfg_smtp_password', 'SMTP服务器的用户密码', '123456', 'string', 1);
