...
if (isset($dopost) && $dopost == 'getone') {
    ...
    //季度
    $starttime = 0;
    if (preg_match("#[123]#", $m) && $m < 10) {
        $starttime = $y . "-01-01 00:00:00";
    } else if (preg_match("#[456]#", $m)) {
        $starttime = $y . "-04-01 00:00:00";
    } else if (preg_match("#[789]#", $m)) {
        $starttime = $y . "-07-01 00:00:00";
    } else {
        $starttime = $y . "-10-01 00:00:00";
    }
