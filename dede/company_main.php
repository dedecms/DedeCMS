...
$sql  = "select ID,userid,pwd,uname,email,sex,money,c1,c2,c3,matt,logintime,loginip,membertype,scores,spaceshow,pageshow
...
$dlist->SetSource($sql);
$dlist->SetTemplet(dirname(__FILE__)."/templets/company_main.htm");
$dlist->display();
$dlist->Close();
ClearAllLink();
?>