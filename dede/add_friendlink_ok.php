<?
require("config.php");
//url,webname,logo,logoimg,msg,email,typeid
...
Values('$url','$fwebname','$imgurl','$msg','$email',$typeid,'$dtime',1)";
$conn = connectMySql();
...
<table width="400"  border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#B6B6B6">
  <tr>
    <td width="100%" height="24" colspan="2" align="center" background="img/tbg.gif"><strong>成功增加一个链接</strong></td>
  </tr>
  <tr>
    <td height="123" colspan="2" align="center" bgcolor="#FFFFFF"><table width="80%" border="0" cellspacing="1" cellpadding="1">
        ...
        <tr>
          <td align="center"><a href="add_friendlink.php">&lt;&lt;返回管理页&gt;&gt;</a>　<a href="<?=$url?>">&lt;&lt;查看链接网站&gt;&gt;</a> 
