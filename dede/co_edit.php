  ...
  <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#98CAEF" align="center" style="margin-bottom:6px">
    <tr> 
      <td height="20" background='img/tbg.gif'><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="47%" height="18"><b>＞更改采集节点：</b></td>
            <td width="53%" align="right"> <input type="button" name="b11" value="节点管理"  class='nbt' style="width:80" onClick="location.href='co_main.php';"> 
              &nbsp; <input type="button" name="b122" value="节点管理"  class='nbt' style="width:80" onClick="location.href='co_url.php';"> 
              &nbsp; </td>
          </tr>
        </table></td>
    </tr>
...
符合特定序列的网址
  ...
  我自己手工指定这些网址
          ...
          <tr> 
            <td height="100">
            	链接区域规则：<br>（如果用正则的形式无法正确获得需要的网址，请设置此选项）<br> 
            </td>
            <td width="42%">
			     起始HTML：<br>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="fieldlist<?php echo $s?>"<?php echo $tstyle?>>
                ...
                <tr> 
                  ...
                  <td height="63"> <input name="isunit<?php echo $s?>" type="checkbox" id="isunit<?php echo $s?>2" value="1" class="np"<?php if($sisunit=='1') echo " checked";?>>
                    分页内容字段（规则中只允许单一的该类型字段）<br/> <input name="isdown<?php echo $s?>" type="checkbox" id="isdown<?php echo $s?>2" value="1" class="np"<?php if($sisdown=='1') echo " checked";?>>
                    下载字段里的多媒体资源 </td>
                </tr>
                <tr> 
