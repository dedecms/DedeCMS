...
$sql .= "Select #@__courl.aid,#@__courl.nid,#@__courl.title,#@__courl.url,";
...
$dlist->SetSource($sql);
if($small==0) $dlist->SetTemplet(dirname(__FILE__)."/templets/co_url.htm");
else $dlist->SetTemplet(dirname(__FILE__)."/templets/co_url_2.htm");
$dlist->display();
$dlist->Close();
?>
