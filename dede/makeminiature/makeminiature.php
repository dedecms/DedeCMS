  ...
  <tr> 
    ...
    <tr> 
      <td height="20" colspan="2" bgcolor="#FAFAF1" align="center">
      	<input name="b112" type="button" class="nbt" value="开始生成缩略图" onClick="document.form1.submit();" style="width:100">
        &nbsp;
        <input type="button" name="b113" value="查看所有文档" class="nbt" onClick="document.form2.submit();" style="width:100"> 
      </td>
    </tr>
  </form>
  <tr bgcolor="#E5F9FF"> 
