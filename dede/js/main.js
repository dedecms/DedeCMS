...
function SeePicNew(f, imgdid, frname, hpos, acname) {
  ...
  if (!newobj) {
    ...
    newobj.innerHTML =
      '<img src="images/loadinglit.gif" width="16" height="16" alit="" />上传中...';
  }
  newobj.style.display = "block";
  //提交后还原form的action等参数
  nForm.action = acname;
...
function SelectFlash() {
  ...
  window.open(
    "./dialog/select_media.php?f=form1.flashurl",
    "popUpFlashWin",
    "scrollbars=yes,resizable=yes,statebar=no,width=500,height=350,left=" +
      posLeft +
      ", top=" +
      posTop
  );
...
function SelectMedia(fname) {
  ...
  window.open(
    "./dialog/select_media.php?f=" + fname,
    "popUpFlashWin",
    "scrollbars=yes,resizable=yes,statebar=no,width=500,height=350,left=" +
      posLeft +
      ", top=" +
...
function SelectSoft(fname) {
  ...
  window.open(
    "./dialog/select_soft.php?f=" + fname,
    "popUpImagesWin",
    "scrollbars=yes,resizable=yes,statebar=no,width=600,height=400,left=" +
      posLeft +
      ", top=" +
      posTop
  );
...
function SelectImage(fname, stype, imgsel) {
  ...
  if (!stype) stype = "";
  window.open(
    "./dialog/select_images.php?f=" +
      fname +
      "&noeditor=yes&imgstick=" +
      stype +
      imgsel,
    "popUpImagesWin",
    "scrollbars=yes,resizable=yes,statebar=no,width=650,height=400,left=" +
      posLeft +
      ", top=" +
      posTop
  );
...
function imageCut(fname) {
  ...
  window.open(
    "imagecut.php?f=" + fname + "&file=" + file,
    "popUpImagesWin",
    "scrollbars=yes,resizable=yes,statebar=no,width=800,height=600,left=" +
      posLeft +
      ", top=" +
      posTop
  );
...
function SelectKeywords(f) {
  ...
  window.open(
    "article_keywords_select.php?f=" + f,
    "popUpkwWin",
    "scrollbars=yes,resizable=yes,statebar=no,width=600,height=450,left=" +
      posLeft +
      ", top=" +
      posTop
  );
...
function OpenMyWin(surl) {
  window.open(
    surl,
    "popUpMyWin",
    "scrollbars=yes,resizable=yes,statebar=no,width=500,height=350,left=200, top=100"
  );
}
...
function OpenMyWinCoOne(surl) {
  window.open(
    surl,
    "popUpMyWin2",
    "scrollbars=yes,resizable=yes,statebar=no,width=700,height=450,left=100,top=50"
  );
}
...
function SelectSource(e) {
  LoadNewDiv(
    e,
    "article_select_sw.php?t=source&k=8&rnd=" + Math.random(),
    "mysource"
  );
  //ChangeFullDiv('show');
}
...
function SelectWriter(e) {
  LoadNewDiv(
    e,
    "article_select_sw.php?t=writer&k=8&rnd=" + Math.random(),
    "mywriter"
  );
  //ChangeFullDiv('show');
}
...
function TestHasTitle(e) {
  LoadNewDiv2(
    e,
    "article_test_title.php?t=" + $Obj("title").value,
    "mytitle",
    "dlgTesttitle"
  );
}
...
function LoadQuickDiv(e, surl, oname, w, h) {
  ...
  newobj.innerHTML =
    '<div style="margin-top:10px;margin-left:10px;"><img src="images/loadinglit.gif" /> Loading...</div>';
  newobj.style.display = "block";
  var myajax = new DedeAjax(newobj);
  myajax.SendGet(surl);
  fixupPos = false;
...
function ShowCatMap(e, obj, cid, targetId, oldvalue) {
  ...
  LoadQuickDiv(
    e,
    "archives_do.php?dopost=getCatMap&targetid=" +
      targetId +
      "&channelid=" +
      cid +
      "&oldvalue=" +
