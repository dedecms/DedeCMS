...
ContextMenu.intializeContextMenu = function () {
  insertHtm(
    document.body,
    '<iframe src="#" scrolling="no" class="WebFX-ContextMenu" marginwidth="0" marginheight="0" frameborder="0" style="position:absolute;display:none;z-index:50000000;" id="WebFX_PopUp"></iframe>',
    true
  );
...
ContextMenu.populatePopup = function (arr, win) {
  ...
  doc.open();
  doc.write(
    '<html><head><link rel="StyleSheet" type="text/css" href="js/contextmenu.css"></head><body></body></html>'
  );
  doc.close();
  //}
  for (i = 0; i < alen; i++) {
