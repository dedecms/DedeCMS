...
$conn = connectMySql();
$query = "Select * from dede_art where ID=$ID And memberID=".$_COOKIE["cookie_user"];
  ...
  <tr> 
	...
	<table width="100%" height="200" border="0" cellpadding="1" cellspacing="1" bgcolor="#000000">
        <tr> 
		  ...
		  <form action="arteditok.php" name="form1" method="post" onSubmit="return checkSubmit();">
		  ...
		  <table width="98%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td height="30" colspan="2"><strong>编辑稿件： </strong></td>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td height="22"><input name="title" type="text" id="title" size="30" value="<?=$row->title?>"></td>
              </tr>
              <tr>
                <td height="22">文章出处：</td>
                <td height="22">
                    <input name="source" type="text" id="source" value="<?=$row->source?>">
                  作者：
                  <input name="writer" type="text" id="writer" size="16" value="<?=$row->writer?>"></td>
              </tr>
              <tr> 
				...
				<select name="typeid" id="typeid">
					<?
					GetOptionArray($row->typeid,$conn);
					?>
                  </select></td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td height="78">&nbsp;</td>
                <td height="78"> <textarea name="msg" cols="50" rows="3" id="msg"><?=$row->msg?></textarea></td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td height="22">&nbsp;</td>
                <td height="22"><textarea name="body" cols="75" rows="14" id="body"><?=str_replace("<br>","",$row->body)?></textarea></td>
              </tr>
              <tr> 
                <td height="73">&nbsp;</td>
