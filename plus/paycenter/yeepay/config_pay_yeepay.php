...
$piice_ex = $priceCount*$payment_exp[4];
...
$p8_Url						= $cfg_basehost.'/plus/paycenter/yeepay/callback.php';	
...
$reqURL_onLineCmd = $cfg_basehost.'/plus/paycenter/yeepay/yeepay_gbk.php';
echo '
<html>
<head>
