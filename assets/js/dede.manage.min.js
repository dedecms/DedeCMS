...
// 删除评论
function DedeCMS_JSCODE_Version_Checked_Feedback_IPALLDelete() {
  var qstr = _DedeCMS_JSCODE_Version_GetCheckboxItem();
  if (qstr == "") {
    alert("必须选择一个或多个文档！");
  } else {
    location = "feedback_main.php?job=delall&fid="+qstr
  }
}
// 删除评论
function DedeCMS_JSCODE_Version_Checked_Feedback_Delete() {
  var qstr = _DedeCMS_JSCODE_Version_GetCheckboxItem();
  if (qstr == "") {
    alert("必须选择一个或多个文档！");
  } else {
    location = "feedback_main.php?job=del&fid="+qstr
  }
}

// 删除评论
function DedeCMS_JSCODE_Version_Checked_Feedback_Check() {
  var qstr = _DedeCMS_JSCODE_Version_GetCheckboxItem();
  if (qstr == "") {
    alert("必须选择一个或多个文档！");
  } else {
    location = "feedback_main.php?job=check&fid="+qstr
  }
}
