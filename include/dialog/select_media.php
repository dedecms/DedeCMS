...
//-----计算文件大小和创建时间
 ...
 else if($file == "..")
 {
    ...
    $line = "\n<tr>
    <td class='linerow'> <a href=select_media.php?f=$f&activepath=".urlencode($tmp).">上级目录<img src=img/dir2.gif border=0 width=16 height=13></a></td>
...
else if(is_dir("$inpath/$file"))
{
   ...
   <td bgcolor='#F9FBF0' class='linerow'>
    <a href=select_media.php?f=$f&activepath=".urlencode("$activepath/$file")."><img src=img/dir.gif border=0 width=16 height=13>$file</a>
   </td>
   <td class='linerow'>-</td>
...
else if(eregi($cfg_mediatype,$file))
{
   ...
   <td class='linerow' bgcolor='#F9FBF0'>
     <a href=\"javascript:ReturnValue('$reurl');\"><img src=img/img.gif border=0 width=16 height=13>$file</a>
   </td>
