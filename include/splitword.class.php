...
class SplitWord
{
    ...
    public $mainDicFileZip = 'data/base_dic_full.zip';
    public $isLoadAll = false;
    public $isUnpacked = false;
    ...
    public function __construct($source_charset = 'utf-8', $target_charset = 'utf-8', $load_all = true, $source = '')
    {
        ...
        if (file_exists(DEDEINC . '/' . $this->mainDicFile)) {
    ...
    public function SplitWord($source_charset = 'utf-8', $target_charset = 'utf-8', $load_all = true, $source = '')
    {
    ...
    public function _optimize_result(&$smarr, $spos)
    {
        $newarr = array();
        $prePos = $spos - 1;
        $arlen = count($smarr);
     ...
     * return string
     */
    public function _out_string_encoding(&$str)
    {
