...
class DedeQrcode
{
    ...
    public function initialize($config = array())
    {
        ...
        include_once dirname(__FILE__)."/qrcode/qrconst.php";
        include_once dirname(__FILE__)."/qrcode/qrtools.php";
        include_once dirname(__FILE__)."/qrcode/qrspec.php";
        include_once dirname(__FILE__)."/qrcode/qrimage.php";
        include_once dirname(__FILE__)."/qrcode/qrinput.php";
        include_once dirname(__FILE__)."/qrcode/qrbitstream.php";
        include_once dirname(__FILE__)."/qrcode/qrsplit.php";
        include_once dirname(__FILE__)."/qrcode/qrrscode.php";
        include_once dirname(__FILE__)."/qrcode/qrmask.php";
        include_once dirname(__FILE__)."/qrcode/qrencode.php";
    }
