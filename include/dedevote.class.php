...
class DedeVote
{
	...
	function GetVoteForm($lineheight=24,$tablewidth="100%",$titlebgcolor="#EDEDE2",$titlebackgroup="",$tablebg="#FFFFFF",$itembgcolor="#FFFFFF")
	{
		...
		$items.="<tr align='center'><td height='$lineheight' style='border:1px dashed #818279' bgcolor='$titlebgcolor' $titlebackgroup><strong>".$this->VoteInfos['votename']."</strong></td></tr>\r\n";
		if($this->VoteCount > 0)
		{
			...
			$items .= "<input type='submit' style='width:60px;background-color:$titlebgcolor;border:1px dotted #818279' name='vbt1' value='投票' />\r\n";
			$items .= "<input type='button' style='width:80px;background-color:$titlebgcolor;border:1px dotted #818279' name='vbt2' ";
