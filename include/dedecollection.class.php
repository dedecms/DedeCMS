...
{
    public $artNotes = array(); //文章采集的字段信息
    public $spNotes = array(); //文章采集的字段信息
    public $lists = array(); //采集节点的来源列表处理信息
    public $noteInfos = array(); //采集节点的基本配置信息
    public $dsql = '';
    public $noteId = '';
    public $cDedeHtml = '';
    public $cHttpDown = '';
    ...
    //测试列表
    public function Testlists(&$dourl)
    {
        $links = array();
