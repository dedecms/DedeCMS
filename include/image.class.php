...
class image
{
    ...
    public $thumbstatus;
    public $watermarkstatus;

    // 析构函数,兼容PHP4
    public function image($targetfile, $cfg_thumb, $cfg_watermarktext, $photo_waterpos, $photo_diaphaneity, $photo_wheight, $photo_wwidth, $cfg_watermarktype, $photo_marktrans, $trueMarkimg, $attach = array())
    {
    ...
    // 析构函数
    public function __construct($targetfile, $cfg_thumb, $cfg_watermarktext, $photo_waterpos, $photo_diaphaneity, $photo_wheight, $photo_wwidth, $cfg_watermarktype, $photo_marktrans, $trueMarkimg, $attach = array())
    {
            ...
            if (($this->watermarktype < 2 && is_readable($watermark_file) || $this->watermarktype == 2) && $wmwidth > 10 && $wmheight > 10 && !$this->animatedgif) {
                ...
                if ($this->watermarktype == 1) {
                    ...
                    if (($this->watermarktext['shadowx'] || $this->watermarktext['shadowy']) && $this->watermarktext['shadowcolor']) {
                        ...
                        imagettftext(
                            $dst_photo, $this->watermarktext['size'], $this->watermarktext['angle'],
